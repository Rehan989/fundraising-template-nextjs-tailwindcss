...
const PricingMd = () => {
    return <div>
        ...
        <div className="p-4 max-w-[78%] bg-white rounded-lg border sm:p-8 dark:bg-gray-800 dark:border-gray-700">
            <h3 className="mb-4 text-xl font-medium text-gray-500 dark:text-gray-400">Standard plan</h3>
            ...
            <button type="button" className="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center">Choose plan</button>
        </div>
